...
export default function VisualImpairConfirmEat() {
  ...
  useEffect(() => {
    // 화면 진입 시 음성 출력
    Speech.speak('먹고가기를 선택하셨습니다. 화면을 탭하면 최종 확정됩니다. 만약 원치 않는다면 일정 시간 후 되돌아갑니다.', { language: 'ko' });
  ...
  const handleScreenTap = () => {
    ...
    Speech.speak('먹고가기 선택.', { language: 'ko' });
  ...
  return (
    <TouchableWithoutFeedback onPress={handleScreenTap}>
      <View style={styles.container}>
        <Text style={styles.title}>먹고가기 주문</Text>
        <Text style={styles.description}>
          식사 후 매장에서 드시기 위해 주문하셨습니다. 화면을 탭하여 확인하세요.
        </Text>
      </View>
